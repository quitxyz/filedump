...
-- Library functions 
    ...
    local cfg = {
        ...
        scale = math.clamp(
            properties.scale
                or properties.Scale
                or properties.ui_scale
                or properties.UIScale
                or 1,
            0.65,
            1.25
        );
...
library:draggify(items["drag_header"], items["main"])
    ...
    function cfg:set_scale(value)
        ...
        value = math.clamp(value, 0.65, 1.25)

        self.scale = value
        items["ui_scale"].Scale = value
    end

    function cfg:get_scale()
        return self.scale
    end
